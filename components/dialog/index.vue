<template>
  <Teleport to="body" :disabled="!appendToBody">
    ...
    >
      <div class="z-dialog" v-show="modelValue" @click.self="handleWrapperClick">
        <div
          ref="dialogRef"
          role="dialog" 
          class="z-dialog__contentbox" 
          :class="[
            {'z-dialog--center': center },
            {'is-draggable': draggable },
            customClass
          ]"
          :style="contentboxStyle"
        >
          <div class="z-dialog__header" ref="headerRef">
            <slot name="header">
