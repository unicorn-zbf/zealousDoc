<template>
  <Teleport to="body" :disabled="!appendToBody">
    <transition name="fade-pupop">
      <div class="z-drawer-pupop" v-if="modelValue" @click="handleWrapperClick"></div>
    </transition>
    <transition 
      :name="animateName"
      ...
      <div 
        ...
        :style="drawerStyle"
      >
        <div class="z-drawer" :class="customClass">
          <div class="z-drawer__header" v-if="withHeader">
            <slot name="header">
              <span class="z-drawer__title">{{ title }}</span>
            </slot>
            <i class="iconfont icon-close" @click="handleClose" v-if="showClose"></i>
          </div>
          <div class="z-drawer__body">
            <slot></slot>
          </div>
          <div class="z-drawer__footer">
...
const handleWrapperClick = (e) => {
  if(props.wrapperClosable){
    if(e.target.className=='z-drawer-pupop'){
      handleClose()
    }
  }
}
