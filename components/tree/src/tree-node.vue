<template>
  <ul class="z-tree-node" :style="nodeStyle">
    <div 
      :class="[
        'z-tree-node__content'
      ]" 
    ...
    <mCollapseTransition :duration="0.3" animate="linear">
      <div class="z-tree-ul-box" v-if="isShow" v-show="items.isOpen">
        <tree-node 
